...
-(NSString *)description { return [NSString stringWithFormat:@"%@ %@",[super description],[titlefield stringValue]]; }
...
@implementation XeeSLText:XeeSLControl
...
-(int)contentWidth { return [textfield frame].size.width;; }
...
-(void)layoutContent:(NSRect)contentrect title:(NSRect)titlerect
{
	[textfield setFrame:contentrect];
...
+(XeeSLText *)textWithTitle:(NSString *)title text:(NSString *)text;
{
	return [[[XeeSLText alloc] initWithTitle:title text:text] autorelease];
}
