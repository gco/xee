...
+(NSString *)null
{
	if(!nullstring) nullstring=[NSMutableString new];
	return nullstring;
}
...
-(NSArray *)allMatches
{
	...
	for(int i=0;i<=preg.re_nsub;i++)
	{
		...
		[array addObject:str?str:[CSRegex null]];
	}
...
{ return [[CSRegex regexWithPattern:pattern options:options] matchesString:self]; }
...
{ return [[CSRegex regexWithPattern:pattern options:options] matchedSubstringOfString:self]; }
...
{ return [[CSRegex regexWithPattern:pattern options:options] capturedSubstringsOfString:self]; }
...
{ return [[CSRegex regexWithPattern:pattern options:options] allMatchedSubstringsOfString:self]; }
...
{ return [[CSRegex regexWithPattern:pattern options:options] allCapturedSubstringsOfString:self]; }
...
{ return [[CSRegex regexWithPattern:pattern options:options] componentsOfSeparatedString:self]; }
